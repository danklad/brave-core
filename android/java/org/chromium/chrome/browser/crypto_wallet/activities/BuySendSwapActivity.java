...
public class BuySendSwapActivity extends BraveWalletBaseActivity
    ...
    private void resetSwapFromToAssets() {
        if (mBlockchainRegistry == null || mCustomAccountAdapter == null
                || !mInitialLayoutInflationComplete) return;
        ...
        TokenUtils.getAllTokensFiltered(mBraveWalletService,
                mBlockchainRegistry, mCurrentSelectedNetwork,
                mCurrentSelectedNetwork.coin, TokenUtils.TokenType.ERC20, allTokens -> {
    ...
    private void resetSwapToAsset(BlockchainToken nativeAsset,
            BlockchainToken[] allTokens, String swapFromAssetSymbol) {
            ...
            mBlockchainRegistry.getTokenBySymbol(mCurrentSelectedNetwork.chainId,
                    mCurrentSelectedNetwork.coin, defaultSwapToAsset, swapToToken -> {
                        if (swapToToken != null) {
                            ...
                            // We are on a chain without BAT. Get first token that is not swapFromAsset.
                            ...
                            if (!success) updateBuySendSwapAsset(nativeAsset.symbol, nativeAsset, false);
                        }
                    });
        }
    }
    ...
    private class FilterTextWatcherSendToAddr implements TextWatcher {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            mValidator.validate(mCurrentSelectedNetwork, getKeyringService(), getBlockchainRegistry(),
