...
#ifndef BRAVE_THIRD_PARTY_BLINK_RENDERER_CORE_BRAVE_PAGE_GRAPH_PAGE_GRAPH_AGENT_H_
#define BRAVE_THIRD_PARTY_BLINK_RENDERER_CORE_BRAVE_PAGE_GRAPH_PAGE_GRAPH_AGENT_H_

#include <vector>

#include "base/unguessable_token.h"
#include "brave/third_party/blink/renderer/core/brave_page_graph/probe_types.h"
...
class CORE_EXPORT PageGraphAgent : public GarbageCollected<PageGraphAgent> {
 public:
  ...
  virtual void RegisterPageGraphBindingEvent(base::StringPiece name,
                                             const char* type,
                                             const char* event) = 0;
  ...
  virtual void WillSendNavigationRequest(uint64_t identifier,
                                         DocumentLoader*,
                                         const KURL&,
...
#endif  // BRAVE_THIRD_PARTY_BLINK_RENDERER_CORE_BRAVE_PAGE_GRAPH_PAGE_GRAPH_AGENT_H_
